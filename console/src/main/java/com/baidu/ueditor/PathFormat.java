...
public class PathFormat {
	...
	private static String getString ( String pattern ) {
		...
		} else if ( pattern.indexOf( PathFormat.DIR ) != -1 ) {
            return PathFormat.getDir();
        }
    ...
    private static String getDir(){
        ...
        if(UserHolder.getType() == null){
            return "unknow";
        }else if(UserHolder.getType() == 1){
            return "admin";
        }else if(UserHolder.getType() == 2){
            return "custom_" + UserHolder.getId();
        }else{
            return "unknow";
        }*/
        return "admin";
